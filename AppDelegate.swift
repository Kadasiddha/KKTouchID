...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func KKgetPathOfDataFile() -> String {
        ...
        let dataFilePath = (documentsPath as NSString).stringByAppendingPathComponent("notesData")
        
        return dataFilePath
    }
    
    
    func KKcheckIfDataFileExists() -> Bool {
        if NSFileManager.defaultManager().fileExistsAtPath(KKgetPathOfDataFile()) {
            return true
        }
